...
class ForwardGroupPage extends GetView<ForwardGroupController> {
  const ForwardGroupPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ForwardGroupController>(
      init: ForwardGroupController(),
      id: "forward_group",
      builder: (_) {
        return Scaffold(
          appBar: MyAppBar(
