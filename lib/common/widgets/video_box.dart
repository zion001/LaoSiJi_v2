...
class _VideoBoxState extends State<VideoBox> {
  ...
  void initState() {
    ...
    if (widget.videoPath.startsWith('http'))
      ...
      _videoBoxController = VideoPlayerController.file(File(widget.videoPath));
...
/// 全屏播放视频
class FullScreenPlayVideoBox extends StatefulWidget {
  /// 视频资源地址
  final String videoPath;
  ...
  @override
  State<FullScreenPlayVideoBox> createState() =>
      _FullScreenPlayVideoBoxState();
}

class _FullScreenPlayVideoBoxState extends State<FullScreenPlayVideoBox> {
  /// 视频播放控制器
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  width: sw([
                                    'zh',
                                    'CH'
                                  ].contains(_currentLocaleLanguageCountryCode)
                                      ? 80
                                      : 150),
                                  height: sh(30),
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          width: sz(1), color: Colors.white),
                                      borderRadius:
                                          BorderRadius.circular(sr(30))),
                                  alignment: Alignment.center,
                                  child: Text(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        // 播放进度
                                        Container(
                                          margin: EdgeInsets.only(left: sh(5)),
                                          child: Text(
                                            _timeLengthSplit(
                                                _fullScreenPlayVideoBoxController!
                                                    .value.position,
