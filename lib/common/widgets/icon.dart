import 'package:badges/badges.dart' as IMBadge;
...
/*      case IconWidgetType.svg:
    ...
    // 圆点
    if (isDot == true) {
      return IMBadge.Badge(
        position: IMBadge.BadgePosition.bottomEnd(bottom: 0, end: -2),
        //       elevation: 0,
    ...
    if (badgeString != null) {
      return IMBadge.Badge(
        ...
        position: IMBadge.BadgePosition.topEnd(top: -7, end: -8),
//        elevation: 0,
//        badgeColor: AppColors.primary,
//        padding: const EdgeInsets.all(4.0),
        child: icon,
