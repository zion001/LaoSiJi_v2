...
import 'package:im_flutter/common/utils/huawei_obs/obs_utils.dart';
...
class OBSClient {
  ...
  static String? huawei_access_host;


  static void init(String ak, String sk, String domain, String bucketName, String  host) {
    OBSClient.ak = ak;
    OBSClient.sk = sk;
    OBSClient.domain = domain;
    OBSClient.bucketName = bucketName;
    OBSClient.huawei_access_host = host;
  }
  ...
  static Future<OBSResponse?> putString(String objectName, String content,
      {String xObsAcl = "public-read"}) async {
    var contentMD5 = ExString(content).toMD5Base64(); // content.toMD5Base64();
  ...
  static Future<OBSResponse?> put(String objectName, data, String md5, int size,
    ...
    String url = "${ObsConfig.host}$objectName";
    ...
    obsResponse.url = url;
    obsResponse.fileName = p.basename(objectName);
    obsResponse.ext = p.extension(objectName);
